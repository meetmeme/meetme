...
=======
								...
								<li><a href="logout.net">logout</a></li>
								<li><img class="header_profilePic img-circle" alt="" src="resources/images/our-blog/img-1.jpg" title="토글 넣을 예정"> </li>
							</c:if>
>>>>>>> Stashed changes
						</ul>
					</div>
...
<div id="nino-searchForm">
	<div class="search-Div">
			<input type="radio" id="searchType-event" name="searchType" value="event" checked="checked">
			<label>Event | </label>
			
			<input type="radio" id="searchType-minihome" name="searchType" value="minihome">
			<label>Mini Home</label>
	</div>
<br><br><br>
	<div id="search-event" class="search-Div">
	<form action="">
	
	<input type="text" placeholder="검색어를 입력해주세요" id="searchEventKeyword" class="form-control nino-searchInput">
	
	<select name="searchCategory" id="search-category" class="form-control">
	...
	<input type=hidden name="search-dateStart" id="search-dateStart">
	...
	<form action="">
	<input type="text" placeholder="검색어" id="searchMinihomeKeyword" class="form-control nino-searchInput">
	<input type="text" placeholder="해시태그" id="searchHashtag" class="form-control nino-searchInput" title="자동완성 넣을 예정">
	<input type="text" placeholder="닉네임" id="searchUser" class="form-control nino-searchInput">
